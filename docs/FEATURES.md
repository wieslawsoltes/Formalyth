...
| Topology editing | Planar face/edge selection, convex chamfers and capped splits, associative face sketches; support-face offsets, all-support solid offsets, neutral-plane draft; inward/outward/symmetric convex shells with openings and wall overrides; sampled straight-edge rounds | Convex inputs only; at most 96 planes for new edits; multiple rounds must be parallel and nonmeeting; no exact curved offsets, rolling-ball corner blends or general semantic naming |
